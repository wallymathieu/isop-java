...
public class ArgumentParserTests {
    ...
    // public void hello() {}
      @Test
        ...
        {
            ParsedArguments parser = new Build()
                .Parameter("&argument")
                .Parse(new String[] { "-a" });
            Collection<RecognizedArgument> arguments = parser.RecognizedArguments;
            /*
             * Assert.That(arguments.size(), Is.EqualTo(1));
        ...
        public void Given_several_arguments_Then_the_correct_one_is_recognized()
        {
            Collection<RecognizedArgument> arguments = new Build()
                .Parameter("&beta")
                .Parse(new String[] { "-a", "-b" }).RecognizedArguments;
/*
        ...
        public void Recognizes_longform()
        {
            Collection<RecognizedArgument> arguments = new Build()
                .Parameter("beta")
                .Parse(new String[] { "-a", "--beta" }).RecognizedArguments;
            /*
            Assert.That(arguments.Count(), Is.EqualTo(1));
            var arg1 = arguments.First();
        ...
        public void It_can_parse_parameter_value()
        {
            Collection<RecognizedArgument> arguments = new Build()
                .Parameter("beta")
                .Parse(new String[] { "-a", "--beta", "value" }).RecognizedArguments;
            /*
            Assert.That(arguments.Count(), Is.EqualTo(1));
            var arg1 = arguments.First();
            Assert.That(arg1.Argument, Is.EqualTo("beta"));
        ...
        public void It_can_parse_ordinal_parameter_value()
        {
            Collection<RecognizedArgument> arguments = new Build()
                .Parameter("#0first")
                .Parse(new String[] { "first" }).RecognizedArguments;
            fail();
            /*
            Assert.That(arguments.Count(), Is.EqualTo(1));
            var arg1 = arguments.First();
        ...
        public void It_can_parse_parameter_with_equals()
        {
            Collection<RecognizedArgument> arguments = new Build()
                .Parameter("beta=")
                .Parse(new String[] { "-a", "--beta=test", "value" }).RecognizedArguments;
            /*
            Assert.That(arguments.Count(), Is.EqualTo(1));
            var arg1 = arguments.First();
        ...
        public void It_can_parse_parameter_alias()
        {
            Collection<RecognizedArgument> arguments = new Build()
                .Parameter("beta|b=")
                .Parse(new String[] { "-a", "-b=test", "value" }).RecognizedArguments;
            /*
            Assert.That(arguments.Count(), Is.EqualTo(1));
            var arg1 = arguments.First();
        ...
        {
            Collection<UnrecognizedArgument> unRecognizedArguments = new Build()
               .Parameter("beta")
               .Parse(new String[] { "-a", "value", "--beta" }).UnRecognizedArguments;
/*
        ...
        public void It_wont_report_matched_parameters()
        {
            Collection<UnrecognizedArgument> arguments = new Build()
                .Parameter("beta")
                .Parse(new String[] { "--beta", "value" }).UnRecognizedArguments;
/*
        ...
        public void It_can_recognize_arguments()
        {
            Collection<RecognizedArgument> arguments = new Build()
                .Parameter("alpha")
                .Parse(new String[] { "alpha" }).RecognizedArguments;
            /*
             Assert.That(arguments.Count(), Is.EqualTo(1));
            var arg1 = arguments.First();
        ...
        public void It_can_parse_class_and_default_method_and_execute()
        {
            ...
            */
            ...
            ParsedArguments arguments = new Build()
                    .Recognize(WithIndexController.class)
                    //.SetFactory(factory)
                    .Parse(new String[] { "WithIndex", /*"Index", */"--param2", "value2", "--param3", "3", "--param1", "value1", "--param4", "3.4" });
            /*
            Assert.That(arguments.UnRecognizedArguments.Count(), Is.EqualTo(0));
            arguments.Invoke(new StringWriter());
            Assert.That(count, Is.EqualTo(1));
  ...
  //              .Parameter("alpha", arg => Assert.Fail())
        ...
        public void It_understands_method_returning_enumerable()
        {
            ...
            */
            ...
            ParsedArguments arguments = new Build()
                   .Recognize(EnumerableController.class)
                   //.SetFactory(factory)
